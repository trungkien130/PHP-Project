            ...
            <div class="control_products_content">
                ...
                <table border="1px" width="100%" cellspacing="0" cellpadding="5">
                    <tbody>
                        <tr>
                            <td>Mã sản phẩm </td>
                            <td><input class="edit_input" type="text" name="MA_SP" id="MA_SP" readonly value="<?php echo $row_edit["MA_SP"]; ?>"></td>
                        </tr>
                        <tr>
                            <td>Tên sản phẩm </td>
                            <td><input class="edit_input" type="text" name="TEN_SP" id="TEN_SP" value="<?php echo $row_edit["TEN_SP"]; ?>"></td>
                        </tr>
                        <tr>
                            <td>Ảnh sản phẩm </td>
                            <td><input class="edit_input" type="file" name="IMG_SP" value="<?php echo $row_edit["IMG_SP"]; ?>"></td>

                        </tr>
                        <tr>
                            <td>Số lượng </td>
                            <td><input class="edit_input" type="text" name="SL_TON" id="SL_TON" value="<?php echo $row_edit["SL_TON"]; ?>"></td>
                        </tr>
                        <tr>
                            <td>Thông tin </td>
                            <td><textarea class="edit_input" name="THONG_TIN"><?php echo $row_edit["THONG_TIN"]; ?></textarea></td>
                        </tr>
                        <tr>
                            <td>Giá nhập </td>
                        ...
                        <tr>
                            <td>Giá cũ </td>
                            <td><input class="edit_input" type="text" name="GIA_CU" id="GIA_CU" readonly value="<?php echo $row_edit["GIA_CU"]; ?>"></td>
                        </tr>
                        <tr>
                            <td>Giá mới </td>
                            <td><input class="edit_input" type="text" name="GIA_MOI" id="GIA_MOI" value="<?php echo $row_edit["GIA_MOI"]; ?>"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
